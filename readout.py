...
class Readout(Module):
    ...
    def fit(self, data: Union[Iterator[Tuple[Tensor, Tensor]], Tuple[Tensor, Tensor]],
            ...
            validate: Optional[Callable[[Tuple[Tensor, Tensor]], float]] = None, batch_mode: bool = False,
            verbose: bool = False):
        """
        Fit readout to data
        ...
        if callable(validate):
            self.weight.data, self.bias.data = fit_and_validate_readout(data, regularization, validate, batch_mode, verbose)
        else:
            self.weight.data, self.bias.data = fit_readout(data, regularization, batch_mode)
...
def fit_readout(data: Iterator[Tuple[Tensor, Tensor]], regularization: Optional[float] = None, batch_mode: bool = False) -> Tuple[Tensor, Tensor]:
    """
...
def fit_and_validate_readout(data: Iterator[Tuple[Tensor, Tensor]], regularization_constants: List[float],
                             get_validation_error: Callable[[Tuple[Tensor, Tensor]], float], batch_mode: bool = False,
    ...
    best_reg, best_validation_error, best_W, best_b = None, None, None, None
    ...
    print("Best VL err:", best_validation_error)
    print("Best lambda:", best_reg)
